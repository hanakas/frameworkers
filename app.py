...
def insert_frameworks(*args, **kwargs):
    Frameworks =[['ICED Theory', 'iced.svg', 'Fuels growth of infrequent products by mapping and managing the I, C, E, and D dimensions (Infrequency, Control, Engagement, and Distinctiveness).'],
                    ['HIPE', 'hipe.svg', 'Evaluates new product ideas and growth opportunities by considering the four factors of Hypothesis, Investment, Precedent, and Experience. '],
                    ['DIBB', 'dibb.svg', 'Builds alignment and transparency by starting with the Data, distilling an Insight from the data, presenting a Belief from the insight, and placing a Bet to pursue and test the belief.'],
                    ['GLEe', 'glee.svg', 'Helps create the next growth wave by defining a new product focus and phasing.'],
                    ['USER', 'user.svg', 'Maximizes product feedback by determining what is worth acting on, what will move the product forward, and what should sit on a shelf.'],
                    ['PESO', 'peso.svg', 'Optimizes marketing communications by categorizing media usage to Paid, Earned, Shared, or Owned media.'], 
                    ['Design Thinking', 'design.svg', 'Encourages innovation through outlining a phase-based process from empathizing with the users to implementing the product.'],
                    ['CIRCLES Method', 'circles.svg', 'Helps evaluate the context, constraints, parameters, and requirements of a product design in a structured manner. '],
                    ['DAU / MAU', 'dau.svg', 'Evaluates the engagement level of the users by calculating the the ratio between the Daily Active Users and Monthyl Active Users.'],
                    ['AIDA', 'aida.svg', 'Identifies the cognitive stages the user experiences before making a consumer decision through understanding the Attention, Interest, Desire, and Action.'],
                    ['Hooked Method', 'hooked.svg', 'Forms user habits by identifying a four-phase loop of trigger, action, variable reward, and investement. '],
                    ['DACI', 'daci.svg', "Assigns specific roles to team member in order to improve a team's effectiveness and velocity on projects."], 
                    ['Product Team Competencies', 'ptc.svg', "Assesses the team's performance and provides alignment on the focus of the product."],
                    ['HEART', 'heart.svg', "Evaluates the user experience (UX) of the product by using five metrics of Happiness, Engagement, Adoption, Retention, and Task success."],
                    ['Net Promoter Score', 'nps.svg', "Measures user loyalty and customer satisfaction to the product to evaluate the performance of the product."],
                    ['Working Backwards', 'wb.svg', "Drafts a mock press release to conduct a gut-check about a product's viability."],
                    ['Customer Journey Map', 'cjm.svg', "Visualizes the stages the users go through when interacting with the product."], 
                    ['4D', '4d.svg', "Breaks down the product development into four distinct phases of Discovery, Design, Delivery, and Deduction."],
                    ['Jobs To Be Done', 'jtbd.svg', "Identifies the need statements of users by understanding the user's specific goal, or 'job', and the thought processes that would lead them to 'hire' the product to complete the job."],
                    ['AARRR Metrics', 'aarrr.svg', "Evaluates user satisfaction through five metrics of Acquisition, Activation, Retention, Referral, and Revenue."],
                    ['Lean Canvas', 'lc.svg', "Creates a 1-page business plan by deconstructing the product idea into its key assumptions."],
                    ['Ansoff Matrix','am.svg', "Identifies growth opportunity by conceptualizing the level of risk associated with different strategies."],
                    ['Opportunity Solution Tree','ost.svg', "Plans the best path to the desired outcome of the product in the ideation/discovery phase by visualizing the opportunities."], 
                    ['Quality Function Deployment','qfd.svg', "Translates user needs into technical requirements for the product's development. "],
                    ['Eisenhower Matrix','em.svg', "Prioritizes a list of tasks or agenda items by categorizing them according to their urgency and importance."],
                    ['OKR','okr.svg', "Formulates outcome-driven goals to ensure team alignment on objectives that matter the most."],
                    ['North Star','ns.svg', "Identifies a single, crucial metric that best captures the core value that a product delivers to the users."],
                    ['GIST Planning','gist.svg', "Plans the development of the product by breaking down the planning horizon into four parts of Goals, Ideas, Step-projects, and Tasks. "],
                    ['666 Roadmap','666.svg', "Outlines a product roadmap over three timelines of the next 6 years, 6 months, and 6 weeks."], 
                    ['Weighted Impact Scoring','wis.svg', "Ranks product features on various criteria using a benefit-versus-cost analysis."],
                    ['RICE','rice.svg', "Scores the features and intitiatives to determine what to put on roadmaps when developing the product."],
                    ['MoSCoW','moscow.svg', "Creates a hierarchy of priorities before and during the project by sorting the requirements in categories of Must have, Should have, Could have, and Will not have."],
                    ['Kano Model','kano.svg', "Prioritizes the initiatives according to which features are most likely to delight customers. "]]
